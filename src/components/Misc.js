            ...
            <Styles>
                ...
                <div className="container-fluid">
                    ...
                    <div className="col-md-5 p-2">
                        ...
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/9" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>The Silent Patient</NavLink> <em>by Alex Michaelides</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/10" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Love etc</NavLink> <em>by Julian Barnes</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/11" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Hullabaloo in the Guava Orchard</NavLink> <em>by Kiran Desai</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/12" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>38 Bahadurabad</NavLink> <em>by Zeeba Sadiq</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/13" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Moonwalking with Einstein</NavLink> <em>by Joshua Foer</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/14" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>The Mystery of the Blue Train</NavLink> <em>by Agatha Christie</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/15" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Alibaba</NavLink> <em>by Duncan Clark</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/16" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Range</NavLink> <em>by David Epstein</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/17" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Predictably Irrational</NavLink> <em>by Dan Ariely</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/18" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Norwegian Wood</NavLink> <em>by Haruki Murakami</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/19" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>So Good They Can't Ignore You</NavLink> <em>by Cal Newport</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/20" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>Men without Women</NavLink> <em>by Haruki Murakami</em></li>
                        <li className="links"><NavLink to="/silkysingh/misc/books/section_3/21" style={{textDecoration:'underline', color:'#000000'}} activeStyle={{color:'#e2498a'}}>The Great Gatsby</NavLink> <em>by F. Scott Fitzgerald</em></li>
