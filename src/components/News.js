        ...
        return(
            <React.Fragment>
                ...
                <ul>
                    ...
                    <li><span style={{color:'black', backgroundColor:'#ffdab9'}}>Jan 2021:</span> Joined AVA group at <a href="https://mpi-sws.org/" style={{color:'#e2498a'}}><u>MPI-SWS</u></a> as a part-time research fellow, under the supervision of <a href="https://malyzajko.github.io/" style={{color:'#e2498a'}}><u>Eva Darulova</u></a> & <a href="https://www.in.tum.de/i02/personen/anastasiia-izycheva/" style={{color:'#e2498a'}}><u>Anastasiia Izycheva</u></a></li>
                    <li><span style={{color:'black', backgroundColor:'#ffefd5'}}>July 2020:</span> Appointed as the coordinator of the <a href="https://ocs.iitd.ac.in/ocs/department.php" style={{color:'#e2498a'}}><u>Nucleus Team(OCS)</u></a>, Dept. of Mathematics IIT Delhi</li>
